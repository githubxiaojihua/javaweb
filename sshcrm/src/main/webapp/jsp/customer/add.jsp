								...
								<td>
									<select name="cust_level.dict_id" style="WIDTH: 180px">
										<s:iterator value="levelList" var="level">
											<option value="<s:property value="#level.dict_id"/>">
												<s:property value="#level.dict_item_name"/>
											</option>
										</s:iterator>
									</select>
								</td>
								...
								<td>
									<select name="cust_source.dict_id" style="WIDTH: 180px">
										<s:iterator value="sourceList" var="source">
											<option value="<s:property value="#source.dict_id"/>">
												<s:property value="#source.dict_item_name"/>
											</option>
										</s:iterator>
									</select>
								</td>
								...
								<td>
									<select name="cust_industry.dict_id" style="WIDTH: 180px">
										<s:iterator value="industryList" var="industry">
											<option value="<s:property value="#industry.dict_id"/>">
												<s:property value="#industry.dict_item_name"/>
											</option>
										</s:iterator>
									</select>
								</td>
