...
public class MyAspact {
     ...
     * 前置增强
     */
    @Before("execution(* com.xiaojihua.domain.Person.save(..))")
     ...
     * 后置增强
     */
    @AfterReturning("execution(* com.xiaojihua.domain.Person.delete(..))")
     ...
     * 环绕增强
     */
    @Around("execution(* com.xiaojihua.domain.Person.find(..))")
     ...
     * 异常增强
     */
    @AfterThrowing("execution(* com.xiaojihua.domain.Person.update(..))")
     ...
     * finally增强
     */
    @After("execution(* com.xiaojihua.domain.Person.update(..))")
