									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR> 
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/customer_find" target=main>－ 客户列表</A>
													</TD>
												</TR>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/linkman_addUI"" target=main>－ 新增联系人</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall>
